-- 1009_v_bus_failure_catalog_coverage.sql
-- Diagnostic view: observed ENQUEUE_PRECHECK_REJECTED failure_codes and whether
-- each code resolves through bus_failure_catalog and bus_findings_catalog.
-- Target: Cloudflare D1 (SQLite)

DROP VIEW IF EXISTS v_bus_failure_catalog_coverage;

CREATE VIEW v_bus_failure_catalog_coverage AS
SELECT
