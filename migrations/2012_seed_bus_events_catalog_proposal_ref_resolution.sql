...
INSERT OR IGNORE INTO bus_events_catalog(
  ...
  ('PROPOSAL_REF_TARGET_TERMINAL_MISMATCH','ERROR','BUS_MESSAGE','RESTART_FROM_JL_PROPOSAL','[]','["request_bus_id", "request_op_id", "proposal_ref_bus_id", "target_bus_id", "target_contract_doc_id"]','proposal_ref.bus_id must target a JL_PROPOSAL response whose contract doc_id is 2PLT_60_IO_CONTRACT_RESPONDER_PROPOSAL'),
