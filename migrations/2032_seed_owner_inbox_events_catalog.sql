-- 2032_seed_owner_inbox_events_catalog.sql
...
INSERT OR IGNORE INTO owner_inbox_events_catalog(
  ...
  ('INBOX_ACK','INFO','OWNER','NOTIFY','["ack_state", "bus_id", "schema_id", "to_owner_id"]','["inbox_id", "note"]','Inbox item acknowledged (inbox-side closure).'),
