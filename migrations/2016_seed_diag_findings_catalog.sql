-- 2014_seed_diag_findings_catalog.sql
...
INSERT INTO diag_findings_catalog(
  ...
  ('diag.trigger.expected_ok','DIAG_CHECK','ERROR','2PLT_40_DIAG_RESULTS_PHASE1D4_ANNEX',NULL,NULL,'INSPECT_TRIGGER_SMOKE_CASE','[]','A positive trigger smoke check did not pass as expected.',1),
  ('diag.catalog.bus_failure.row_count','DIAG_CHECK','ERROR','2PLT_40_DIAG_RESULTS_PHASE1D4_ANNEX',NULL,NULL,'REPAIR_DIAGNOSTIC_CATALOG_SEED','[]','bus_failure_code_catalog does not contain the expected minimum row count.',1),
  ('diag.catalog.bus_failure.proposal_ref_count','DIAG_CHECK','ERROR','2PLT_40_DIAG_RESULTS_PHASE1D4_ANNEX',NULL,NULL,'REPAIR_BUS_FAILURE_CODE_CATALOG','[]','proposal_ref failure_code catalog row count is not the expected value.',1),
  ('diag.catalog.bus_failure.unresolved_observed_code','DIAG_CHECK','ERROR','2PLT_40_DIAG_RESULTS_PHASE1D4_ANNEX',NULL,NULL,'REPAIR_BUS_FAILURE_CODE_CATALOG','[]','Observed ENQUEUE_PRECHECK_REJECTED failure codes do not resolve through bus_failure_code_catalog.',1),
  ('diag.catalog.metadata.missing','DIAG_CHECK','ERROR','2PLT_40_DIAG_RESULTS_PHASE1D4_ANNEX',NULL,NULL,'REPAIR_DIAGNOSTIC_CATALOG_METADATA','[]','Diagnostic catalog metadata is incomplete or invalid.',1),
  ('diag.catalog.coverage.unresolved','DIAG_CHECK','ERROR','2PLT_40_DIAG_RESULTS_PHASE1D4_ANNEX',NULL,NULL,'REPAIR_BUS_FAILURE_CODE_CATALOG','[]','v_failure_code_catalog_coverage reports unresolved observed failure codes.',1);
