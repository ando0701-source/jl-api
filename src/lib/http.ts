...
export const API_ERROR_CODES = {
  ...
  INVALID_IO_MODE: "invalid_io_mode",
  INVALID_OP_ID: "invalid_op_id",
  INVALID_OP_KIND: "invalid_op_kind",
  INVALID_OP_PATH: "invalid_op_path",
  ...
  OP_ID_IN_STATE_MISMATCH: "op_id_in_state_mismatch",
  TERMINAL_NOT_ALLOWED: "terminal_not_allowed",
  PROFILE_DOC_ID_OP_MISMATCH: "profile_doc_id_op_mismatch",
